    ...
    Component {
        ...
        QGCPopupDialog {
            ...
            Column {
                ...
                QGCLabel { text:       qsTr("<b> Max Cache Disk Size (MB): </b>"); font.pointSize: 11 }
                ...
                QGCLabel {
                    ...
                    text:           qsTr("<b> Max Cache Memory Size (MB): </b>")
                    font.pointSize: 11
                }
                ...
                QGCLabel { text: qsTr("<b> Mapbox Access Token </b>"); visible: _mapboxFact ? _mapboxFact.visible : false; font.pointSize: 11 }
                FactTextField {
                    fact:               _mapboxFact
                ...
                QGCLabel { text: qsTr("<b> Mapbox User Name </b>"); visible: _mapboxAccountFact ? _mapboxAccountFact.visible : false; font.pointSize: 11 }
                FactTextField {
                ...
                QGCLabel { text: qsTr("<b> Mapbox Style ID </b>"); visible: _mapboxStyleFact ? _mapboxStyleFact.visible : false; font.pointSize: 11 }
                FactTextField {
                ...
                QGCLabel { text: qsTr("<b> Esri Access Token </b>"); visible: _esriFact ? _esriFact.visible : false; font.pointSize: 11 }
                FactTextField {
                    fact:               _esriFact
                ...
                QGCLabel { text: qsTr("<b> VWorld Access Token </b>"); visible: _vworldFact ? _vworldFact.visible : false; font.pointSize: 11 }
                FactTextField {
                    fact:               _vworldFact
                ...
                QGCLabel { text: qsTr("<b> Custom Map URL </b>"); visible: _customURLFact ? _customURLFact.visible : false; font.pointSize: 11 }
                FactTextField {
                    fact:               _customURLFact
