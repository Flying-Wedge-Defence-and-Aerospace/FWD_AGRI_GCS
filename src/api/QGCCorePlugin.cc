...
public:
    ...
    QmlComponentInfo* VehicleSetup              = nullptr;
    QmlComponentInfo* AnalyzeTools              = nullptr;
    QmlComponentInfo* AppSettings               = nullptr;

    QGCOptions*         defaultOptions          = nullptr;
    QVariantList        settingsList;
    QVariantList        analyzeList;
    QVariantList        settingsToolsList;
...
{
    if(!_p->VehicleSetup) {
        _p->VehicleSetup = new QmlComponentInfo(tr("Vehicle Setup"), QUrl::fromUserInput("qrc:/qml/SetupView.qml")),
            QUrl::fromUserInput("/qmlimages/Gears.svg");
        _p->settingsToolsList.append(QVariant::fromValue(reinterpret_cast<QmlComponentInfo*>(_p->VehicleSetup)));

        _p->AnalyzeTools = new QmlComponentInfo(tr("Analyze Tools"), QUrl::fromUserInput("qrc:/qml/AnalyzeView.qml")),
            QUrl::fromUserInput("/qmlimages/Analyze.svg");
        _p->settingsToolsList.append(QVariant::fromValue(reinterpret_cast<QmlComponentInfo*>(_p->AnalyzeTools)));

        _p->AppSettings = new QmlComponentInfo(tr("Application Settings"), QUrl::fromUserInput("qrc:/qml/AppSettings.qml")),
            QUrl::fromUserInput("/res/FWD_only_logo");
        _p->settingsToolsList.append(QVariant::fromValue(reinterpret_cast<QmlComponentInfo*>(_p->AppSettings)));
    }
    return _p->settingsToolsList;
}
...
QVariantList &QGCCorePlugin::settingsPages()
{
    if(!_p->pGeneral) {
        ...
        _p->pOfflineMaps = new QmlComponentInfo(tr("Offline Maps"),
                                                ...
                                                QUrl::fromUserInput("qrc:/res/offlineMap_icon"));
        ...
        _p->pConsole = new QmlComponentInfo(tr("Console"),
                                            ...
                                            QUrl::fromUserInput("qrc:/res/console_icon"));
        ...
        _p->pMockLink = new QmlComponentInfo(tr("Mock Link"),
                                             ...
                                             QUrl::fromUserInput("qrc:/res/mockLink_icon"));
        ...
        _p->pDebug = new QmlComponentInfo(tr("Debug"),
                                          ...
                                          QUrl::fromUserInput("qrc:/res/debug_icon"));
        ...
        _p->pQmlTest = new QmlComponentInfo(tr("Palette Test"),
                                            ...
                                            QUrl::fromUserInput("qrc:/res/palette_icon"));
...
void QGCCorePlugin::createRootWindow(QQmlApplicationEngine* qmlEngine)
{
    ...
    //qDebug() << "Loading LoginPage.qml...";
    //qmlEngine->load(QUrl(QStringLiteral("qrc:/qml/LoginPage.qml")));
    //qDebug() << "LoginPage.qml load attempted.";
}
