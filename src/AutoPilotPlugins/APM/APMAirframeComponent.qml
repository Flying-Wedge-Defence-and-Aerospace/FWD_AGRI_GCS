        ...
        ColumnLayout {
            ...
            Grid {
                ...
                Repeater {
                    ...
                    Rectangle {
                        id:     outerRect
                        visible: object.name === "Quad" || object.name === "Hexa" || object.name === "Octa"
                        width:  _boxWidth + 50
                        ...
                        Rectangle {
                            ...
                            gradient: Gradient {                     // gradient background instead of flat
                                GradientStop { position: 0.0; color: airframeCheckBox.checked ? "#aa2a3f" : "#5a1a1a" }
                                GradientStop { position: 1.0; color: airframeCheckBox.checked ? "#3a3a3a" : "#222222" }
                            }
