...
public:
    ...
    //Q_INVOKABLE void startOverRiding(int channelNo);
    //Q_INVOKABLE void startOverrideStream(int channel, int value);

    // Q_INVOKABLE void cycleFlightModeViaRC5(/*int channelNo*/);
    //void setCustomRCValues(int channelNo);
    // Q_INVOKABLE void setCustomRC1Values();
    // Q_INVOKABLE void setCustomRC2Values();
    // Q_INVOKABLE void setCustomRC3Values();
    // Q_INVOKABLE void setCustomRC4Values();
    // Q_INVOKABLE void setCustomRC5Values();
    // Q_INVOKABLE void setCustomRC6Values();
    // Q_INVOKABLE void setCustomRC7Values();
    // Q_INVOKABLE void setCustomRC8Values();

    //Q_INVOKABLE void overrideRCChannel(int channel, int trimValue, int minValue, int maxValue);

    void printAllRCChannelValues();
    void sendRCOverrides(int channelIndex, int pwmValue);
    void _sendOverride();
    ...
    QTimer* _rcOverrideTimer = nullptr;
    int _overrideChannel = 0;
    int _overrideValue = 0;
...
private:
    ...
    int _rc6ModeIndex = 0; // 0 to 5
    int pwm;
    QMap<int, int> overrides;

    QTimer* _overrideTimer = nullptr;
    int     _pwmOverrideValue = 0;
