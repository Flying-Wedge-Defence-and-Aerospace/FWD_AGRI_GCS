...
public:
    ...
    //Q_INVOKABLE void startOverride(int channelNo, int pwmValue);

    Q_INVOKABLE void _sendOverrideValue(int channelNo, int overrideValue);
    Q_INVOKABLE void moveServo(int servoNumber, float pwmValue);
    ...
    */
    ...
    uint16_t _latestRcValues[Vehicle::cMaxRcChannels] = { UINT16_MAX };
