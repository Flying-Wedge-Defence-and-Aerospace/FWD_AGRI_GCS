...
public:
    ...
    SharedLinkInterfacePtr _primarySharedLink;

    SharedLinkInterfacePtr primarySharedLink() const { return _primarySharedLink; }

    int linkCount() const { return _rgLinkInfo.count(); }
