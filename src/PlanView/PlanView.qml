...
Item {
    ...
    property bool wayPointStarted: false
    property bool rallyPointStarted: false
    ...
    // In your parent scope (same level as QGCButton and ListView)
    function removeMissionItemAt(index) {
    ...
    Item {
        ...
        FlightMap {
            ...
            MissionLineView {
                ...
                property int lineCount: model ? model.count : 0

                onModelChanged: {
                        if (model) {
                            model.countChanged.connect(function() {
                                lineCount = model.count
                            })
                        }
                    }
        ...
        ToolStrip {
            ...
            anchors.topMargin:      _toolsMargin + 50
            ...
            ToolStripActionList {
                ...
                model: [
                    ...
                    ToolStripAction {
                        text: qsTr("Undo")
                        iconSource: "/res/undo_icon"
                        visible: wayPointStarted && addWaypointRallyPointAction.enabled
                        enabled: /*missionLineView.model && missionLineView.model.count > 0*/ missionLineView.lineCount > 0
                        onTriggered: {
                            if (_missionController.visualItems.count > 0) {
                                removeMissionItemAt(_missionController.visualItems.count - 1)
                            }
                        }
                    }
                ]
    ...
    Component {
        ...
        ColumnLayout {
            spacing:    (ScreenTools.defaultFontPixelWidth * 0.5) + 5

            QGCLabel { text: qsTr("CREATE COMPLEX PATTERN"); font.bold: true }
    ...
    Component {
        ...
        ColumnLayout {
            ...
            GridLayout {
                columns:            2
                columnSpacing:      _margin + 5
                rowSpacing:         _margin + 5
                Layout.fillWidth:   true
                ...
                Repeater {
                    ...
                    Rectangle {
                        id: button
                        visible: object.name === "Planning"   // 👈 only show Survey
                        radius: 5
                        // border.color: "white"
                        ...
                        Image {
                            id:                 planCreatorImage
                            anchors.top: planCreatorNameLabel.bottom
                            anchors.topMargin: 5
                            anchors.left:       parent.left
                            anchors.right:      parent.right
            ...
            ColumnLayout {
                ...
                Item {
                    ...
                    property int contentHeight: dropdownContent.implicitHeight
                    height: storageSectionHolder.expanded ? contentHeight : 0
            ...
            ColumnLayout {
                ...
                Item {
                    ...
                    Layout.fillWidth: true
                    clip: true
                    property int contentHeight: vehicleDropdown.implicitHeight
                    height: vehicleSectionHeader.expanded ? contentHeight : 0
    ...
    Rectangle {
        ...
        Timer {
            ...
            repeat: false
            onTriggered: {
                waypointToast.opacity = 0
                waypointToast.visible = false
            }
        }
