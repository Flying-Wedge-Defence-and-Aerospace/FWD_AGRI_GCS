    ...
    QGCFlickable {
        ...
        Column {
            ...
            Row {
                ...
                // Edit theme GroupBox
                GroupBox {
                    title: "<b> Preview and edit theme </b>"
                Column {
                    id: editRoot
                    spacing: 5
                ...
                GroupBox { title: "<b> Controls preview </b>"
                Column {
                    id: ctlPrevColumn
                    ...
                    Grid {
                        ...
                        Loader {
                            ...
                            property string text: "<b> QGCLabel </b>"
                        }
                        Rectangle {
                            width: ctlPrevColumn._colWidth
                            height: ctlPrevColumn._height
                        ...
                        Loader {
                            sourceComponent: ctlRowHeader
                            property string text: "<b> QGCButton </b>"
                        }
                        QGCButton {
                            width: ctlPrevColumn._colWidth
                            height: ctlPrevColumn._height
                        ...
                        Loader {
                            sourceComponent: ctlRowHeader
                            property string text: "<b> QGCButton(primary) </b>"
                        }
                        QGCButton {
                            width: ctlPrevColumn._colWidth
                            height: ctlPrevColumn._height
                        ...
                        Loader {
                            sourceComponent: ctlRowHeader
                            property string text: "<b> ToolStripHoverButton </b>"
                        }
                        ToolStripHoverButton {
                            width:  ctlPrevColumn._colWidth
                        ...
                        Loader {
                            sourceComponent: ctlRowHeader
                            property string text: "<b> QGCButton(menu) </b>"
                        }
                        Menu {
                            id: buttonMenu
                            QGCMenuItem {
                        ...
                        Loader {
                            sourceComponent: ctlRowHeader
                            property string text: "<b> QGCRadioButton </b>"
                        }
                        Rectangle {
                            width: ctlPrevColumn._colWidth
                            height: ctlPrevColumn._height
                        ...
                        Loader {
                            sourceComponent: ctlRowHeader
                            property string text: "<b> QGCCheckBox </b>"
                        }
                        Rectangle {
                            width: ctlPrevColumn._colWidth
                            height: ctlPrevColumn._height
                        ...
                        Loader {
                            sourceComponent: ctlRowHeader
                            property string text: "<b> QGCTextField </b>"
                        }
                        QGCTextField {
                            width: ctlPrevColumn._colWidth
                            height: ctlPrevColumn._height
                        ...
                        Loader {
                            sourceComponent: ctlRowHeader
                            property string text: "<b> QGCComboBox </b>"
                        }
                        QGCComboBox {
                            width: ctlPrevColumn._colWidth
                            height: ctlPrevColumn._height
                        ...
                        Loader {
                            sourceComponent: ctlRowHeader
                            property string text: "<b> SubMenuButton </b>   "
                        }
                        SubMenuButton {
                            width: ctlPrevColumn._colWidth
