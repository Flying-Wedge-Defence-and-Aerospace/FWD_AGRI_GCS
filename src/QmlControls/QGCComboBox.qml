...
T.ComboBox {
    ...
    delegate: ItemDelegate {
        ...
        contentItem: Text {
            text:                   _text
            font:                   control.font
            color:                 /* control.currentIndex === index ? /*_qgcPal.buttonHighlightText*/ /*"black" : _qgcPal.buttonText */ "black"
            verticalAlignment:      Text.AlignVCenter
        }

        background: Rectangle {
            color:                  control.currentIndex === index ? "white" /*_qgcPal.buttonHighlight*/ : /*_qgcPal.button*/ "gray"
        }
