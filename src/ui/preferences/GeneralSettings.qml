    ...
    QGCFlickable {
        ...
        Column {
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        FactComboBox {
                            ...
                            Layout.preferredWidth: lan_textMetrics.width + 40

                            TextMetrics {
                                id: lan_textMetrics
                                text: languageComboBox.displayText   // displayText is the visible text in combo
                    ...
                    RowLayout {
                        ...
                        FactComboBox {
                            id: indoorPaletteCombo
                            fact:                   QGroundControl.settingsManager.appSettings.indoorPalette
                            indexModel:             false
                            visible:                QGroundControl.settingsManager.appSettings.indoorPalette.visible

                            // Auto width based on current text
                            Layout.preferredWidth: textMetrics.width + 40  // +40 for padding & dropdown icon

                            TextMetrics {
                                id: textMetrics
                                text: indoorPaletteCombo.displayText   // displayText is the visible text in combo
                                font: indoorPaletteCombo.font
                            }
                        }
                    }
                    ...
                    RowLayout {
                        ...
                        FactComboBox {
                            id: stGCSPos
                            //Layout.preferredWidth:  _comboFieldWidth + 20
                            fact:                   _followTarget
                            indexModel:             false
                            visible:                _followTarget.visible
                            Layout.preferredWidth: stGCSPOS_tm.width + 40

                            TextMetrics {
                                id: stGCSPOS_tm
                                text: stGCSPos.displayText   // displayText is the visible text in combo
                                font: stGCSPos.font
                            }
                        }
                    }
                    ...
                    RowLayout {
                        ...
                        QGCToggleSwitch {
                            id: clearSettingsSwitch
                            visible:    QGroundControl.settingsManager.appSettings.audioMuted.visible
                            checked: false
                            onCheckedChanged: {
                            ...
                            MessageDialog {
                                ...
                                onNo: {
                                    clearSettingsSwitch.checked  = false
                                    clearDialog.visible = false
                                }
                            }
                        }
            ...
            Rectangle {
                id: unitsBox
                width: ScreenTools.defaultFontPixelWidth * 75  /*ScreenTools.defaultFontPixelWidth * 8 * (Screen.pixelDensity / 160)*/     // small width
                height: unitsColLayout.height + 20    // height to fit 3 numbers
                radius: 6
                color: "transparent"
                border.color: "#888"
                anchors.horizontalCenter: parent.horizontalCenter
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        FactComboBox {
                            ...
                            indexModel:             false
                            Layout.preferredWidth: horDisMetrics.width + 40

                            TextMetrics {
                                id: horDisMetrics
                                text: horDis.displayText   // displayText is the visible text in combo
                                font: horDis.font
                            }
                        }
                    }
                    ...
                    RowLayout {
                        ...
                        FactComboBox {
                            ...
                            indexModel:             false
                            Layout.preferredWidth: verDisMetrics.width + 40

                            TextMetrics {
                                id: verDisMetrics
                                text: verDis.displayText   // displayText is the visible text in combo
                                font: verDis.font
                            }
                        }
                    }
                    ...
                    RowLayout {
                        ...
                        FactComboBox {
                            ...
                            indexModel:             false
                            Layout.preferredWidth: areaMetrics.width + 40

                            TextMetrics {
                                id: areaMetrics
                                text: area.displayText   // displayText is the visible text in combo
                                font: area.font
                            }
                        }
                    }
                    ...
                    RowLayout {
                        ...
                        FactComboBox {
                            ...
                            indexModel:             false
                            Layout.preferredWidth: speedMetrics.width + 40

                            TextMetrics {
                                id: speedMetrics
                                text: speed.displayText   // displayText is the visible text in combo
                                font: speed.font
                            }
                        }
                    }
                    ...
                    RowLayout {
                        ...
                        FactComboBox {
                            ...
                            indexModel:             false
                            Layout.preferredWidth: tempMetrics.width + 40

                            TextMetrics {
                                id: tempMetrics
                                text: temperature.displayText   // displayText is the visible text in combo
