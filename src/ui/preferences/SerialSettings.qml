...
ColumnLayout {
    ...
    GridLayout {
        ...
        QGCLabel { text: qsTr("Serial Port"); font.pointSize: 10; font.bold: true }
        QGCComboBox {
            id:                     commPortCombo
        ...
        QGCLabel { text: qsTr("Baud Rate"); font.pointSize: 10; font.bold: true }
        QGCComboBox {
            id:                     baudCombo
            Layout.preferredWidth:  _secondColumnWidth
    ...
    GridLayout {
        ...
        QGCLabel { text: qsTr("Parity"); font.pointSize: 10; font.bold: true}
        QGCComboBox {
            Layout.preferredWidth:  _secondColumnWidth
        ...
        QGCLabel { text: qsTr("Data Bits"); font.pointSize: 10; font.bold: true }
        QGCComboBox {
            Layout.preferredWidth:  _secondColumnWidth
            model:                  [ "5", "6", "7", "8" ]
        ...
        QGCLabel { text: qsTr("Stop Bits"); font.pointSize: 10; font.bold: true }
        QGCComboBox {
            Layout.preferredWidth:  _secondColumnWidth
            model:                  [ "1", "2" ]
