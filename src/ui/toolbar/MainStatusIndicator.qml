...
ColumnLayout {
    ...
    Rectangle {
       color: "transparent"
       Layout.preferredWidth: mainStatusLabel.implicitWidth + (ScreenTools.defaultFontPixelWidth * 4)
       Layout.preferredHeight: mainStatusLabel.height + (ScreenTools.defaultFontPixelHeight / 2)
       ...
       QGCLabel {
          id:             mainStatusLabel
          text:           mainStatusText()
          font.pointSize: ScreenTools.isMobile ? 8.5 : 12
          ...
          QGCMouseArea {
             ...
             hoverEnabled: true
             onClicked:              mainWindow.showIndicatorPopup(mainStatusLabel, sensorStatusInfoComponent, "top")
          }
       }
    }
