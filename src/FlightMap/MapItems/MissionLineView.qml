...
MapItemView {
    ...
    property bool isLineInScreen: false

    property var lineCount: missionLineView.count
    ...
    delegate: MapPolyline {
        ...
        line.color: _terrainCollision ?
                        "red" :
                        (false/*showSpecialVisual*/ ? "green" : /*QGroundControl.globalPalette.mapMissionTrajectory*/ "white")
