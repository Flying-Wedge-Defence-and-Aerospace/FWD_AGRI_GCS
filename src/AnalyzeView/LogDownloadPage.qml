...
AnalyzePage {
    ...
    Component {
        ...
        ColumnLayout {
            ...
            //     color: "#2c3e50"         // overall table background
            //     radius: 6
            //     border.color: "#22303a"
            //     border.width: 1
            ...
            //             delegate: Rectangle {
            //                 width: parent ? parent.width : tableView.width
            //                 height: 30
            //                 color: styleData.selected ? "#1abc9c" : (styleData.row % 2 === 0 ? "#34495e" : "#2c3e50")
            ...
            //                         if (o && o.received) {
            //                             var d = o.time
            //                             if (d.getUTCFullYear() < 2010) return qsTr("Date Unknown")
